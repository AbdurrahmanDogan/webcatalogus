...
const konamii = document.querySelector('.konamii');

function showKonami(konamiData) {
    console.log(konamiData);


    for (let a = 0; a < konamiData.length; a++) {
        const b = konamiData[a];
